...
import sima.basic.broadcast.basic.BasicBroadcast;
...
public class ReliableBroadcast extends BasicBroadcast {
    ...
    /**
     * Send the {@link sima.basic.broadcast.basic.BroadcastMessage} to all others members of the {@link #getGroupMemberShip()} excepted us.
     *
     * @param broadcastMessage the {@link sima.basic.broadcast.basic.BroadcastMessage} to resend
     */
