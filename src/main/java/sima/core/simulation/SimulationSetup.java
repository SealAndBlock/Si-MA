 ...
 * allows passing argument to the SimulationSetup.
 */
public interface SimulationSetup {
     ...
     * simulation.
     * <p>
     * In this method you can add more agents which are not define in the simulation, and you must create some event for
     * that the simulation begin, else the simulation will stop directly after its start because there is no event to
     * execute.
     * <p>
