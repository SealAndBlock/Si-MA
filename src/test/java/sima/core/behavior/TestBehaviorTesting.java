...
class TestBehaviorTesting extends GlobalTestBehavior {
    ...
    @Test
    void constructBehaviorTestingWithNullAgentThrowsException() {
        assertThrows(NullPointerException.class, () -> new BehaviorTesting(null, null));
    }
    
    @Test
    void constructBehaviorTestingWithNullArgsNotFail() {
    ...
    @Test
    void constructBehaviorTestingWithNotNullArgsNotFail() {
        AbstractAgent agent = new AgentTesting("A_0", 0, 0, null);
        assertDoesNotThrow(() -> {
            try {
    ...
    @Test
    void constructBehaviorTestingWithNotPlayableAgentThrowsException() {
        AbstractAgent agent = new AgentTesting("A_0", 0, 0, null);
    ...
    @Test
    void startPlayingCallOnStartPlaying() {
    ...
    @Test
    void stopPlayingCallOnStopPlaying() {
        BEHAVIOR.startPlaying();
