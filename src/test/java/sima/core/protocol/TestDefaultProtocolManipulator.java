...
class TestDefaultProtocolManipulator extends GlobalTestProtocolManipulator {
    ...
    @Test
    void constructDefaultProtocolManipulatorWithNullProtocolThrowsException() {
        assertThrows(NullPointerException.class, () -> new ProtocolManipulator.DefaultProtocolManipulator(null));
    }
    
    @Test
    void constructDefaultProtocolManipulatorWithNotNullProtocolThrowsException() {
        AbstractAgent a = new AgentTesting("A_0", 0, 0, null);
        Protocol protocol = new ProtocolTesting("P_TAG_0", a, null);
