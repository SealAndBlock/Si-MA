...
class TestSimaSimulationUtils extends SimaTest {
    ...
    @Test
    void randomLongWithBoundAlwaysReturnsValueInDefineInterval() {
        Random r = new Random();
        long min;
        long max;
    ...
    @Test
    void randomLongWithBoundAlwaysReturnsAlwaysMinIfMaxAndMinAreEquals() {
        Random r = new Random();
    ...
    @Test
    void randomIntWithBoundAlwaysReturnsValueInDefineInterval() {
        Random r = new Random();
        int min;
        int max;
    ...
    @Test
    void randomIntWithBoundAlwaysReturnsAlwaysMinIfMaxAndMinAreEquals() {
        Random r = new Random();
