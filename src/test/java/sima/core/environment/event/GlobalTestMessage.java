...
public abstract class GlobalTestMessage extends GlobalTestEvent {
    ...
    public void cloneForMessageWithNullContentDoesNotFail() {
        assertDoesNotThrow(() -> MESSAGE_WITH_NULL_CONTENT.duplicate());
    }
    
    @Test
    public void duplicateWithNewReceiverForMessageWithNotNullContentNotThrowException() {
        assertDoesNotThrow(() -> MESSAGE_PROTOCOL_EVENT.duplicateWithNewReceiver(new AgentIdentifier("Test", 0, 0)));
    }
    
    @Test
    public void duplicateWithNewReceiverForMessageWithNullContentNotThrowException() {
        assertDoesNotThrow(() -> MESSAGE_WITH_NULL_CONTENT.duplicateWithNewReceiver(new AgentIdentifier("Test", 0, 0)));
    }
}
