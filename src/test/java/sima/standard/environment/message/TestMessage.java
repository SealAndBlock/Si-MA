...
public class TestMessage {
    ...
    class ConstructorTest {
        ...
        void testConstructorWithNullIntendedProtocol() {
            assertThrows(IllegalArgumentException.class, () -> new Message(mockContentMessage, null));
        }
    ...
    class DuplicateTest {
        ...
        void testDuplicate() {
            ...
            // THEN
            assertThat(duplicateMessage.getIntendedProtocol()).isSameAs(message.getIntendedProtocol());
            if (message.getContent() != null) {
                verify(mockContentMessage, times(1)).duplicate();
                assertThat(duplicateMessage.getContent()).isNotSameAs(message.getContent());
            }
        }
